...
def generate_yaml_inventory(instances_data, output_file, ssh_key_path):
...
def generate_ini_inventory(instances_data, output_file, ssh_key_path):
    ...
    with open(output_file, 'w') as f:
        ...
        # Write all:vars section with SSH key
        f.write("[all:vars]\n")
...
def main():
    ...
    parser.add_argument('--ssh-key', default='/home/ansible/.ssh/ansible_key', 
    ...
    if args.format == 'yaml':
        generate_yaml_inventory(instances_data, output_file, args.ssh_key)
    else:
        generate_ini_inventory(instances_data, output_file, args.ssh_key)
